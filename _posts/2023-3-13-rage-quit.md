...
title: Rage Quit
---
Thinking About Rage Quit

Disclaimer: Prop 248 has none of the properties that we traditionally associate with rage quit such as protection from 51% attacks. It is rage quit in name alone. The verbs implementation is a better starting point for Nouns rage quit. You can read about it here:

https://hackmd.io/jctHoCh0STORZGyJIQKpMA?view
